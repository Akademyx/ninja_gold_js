...
var dbURI = 'mongodb://localhost/ninja_gold'
...
app.use(express.static(__dirname + '/ninjaGoldApp/dist'));
...
app.get('/tasks', function (req, res) {
    console.log("get route of /tasks")
...
app.get('/new/:title/:des', function (req, res) {
